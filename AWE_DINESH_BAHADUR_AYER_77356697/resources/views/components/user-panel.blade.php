<div class="modal">
    <div class="modal-profile">
        ...
        @can('post-create')
            <a href="{{ route('posts.create') }}" class="button"><i class="fa-solid fa-plus"></i><p>Add a post</p></a>
        @endcan
        @can('category-create')
        ...
        @endcan
        @can('role-create')
            <a href="{{ route('roles.create') }}" class="button"><i class="fa-solid fa-wrench"></i><p>Add roles</p></a>
        @endcan
