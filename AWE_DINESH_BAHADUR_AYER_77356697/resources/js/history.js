...
window.show = function (id = null, history_id, compare = false) {
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            const body =
                '<div class="actions"><a><i class="fa-solid fa-arrow-left"></i> Return to home page</a><a>Next post <i class="fa-solid fa-arrow-right"></i></a></div>';
...
window.revert = function (postId, historyId) {
    Swal.fire({
        title: "Are you sure?",
        html: "Are you sure you want to restore?<p style='font-size: 15px; font-weight: 400; margin-top: 5px;'>Information:<br>After restoring, the post will be updated and you will be able to edit it.</p>",
        icon: "warning",
