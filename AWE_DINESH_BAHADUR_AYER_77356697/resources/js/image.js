...
window.deleteImage = function (event) {
    Swal.fire({
        title: "Are you sure?",
        html: "Are you sure you want to delete?<p style='font-size: 15px; font-weight: 400; margin-top: 5px;'>Information:<br>This action is not recommended.</p>",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
        confirmButtonText: "I confirm, delete!",
