...
<head>
    <meta charset="UTF-8">
    <title>Password Reset - Awesome Grocery store</title>
    <style>
        body {
...
<div class="container">
    ...
    <div class="additional-text">
        <p>Your Email verification has been successfully done, here is your Password Reset OTP below. The OTP is valid for 15 minutes.</p>
    </div>
